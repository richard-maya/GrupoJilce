<?php
define('EMAIL_FOR_REPORTS', 'servicioalcliente@grupo-jilce.com');
define('RECAPTCHA_PRIVATE_KEY', '@privatekey@');
define('FINISH_URI', 'https://grupo-jilce.com/confirmacion.html');
...
function frmd_handler(){
    ...
    $report .= '<h2>Hola Jilce,</h2> <p>Un usuario llenó el formulario de contacto en grupo-jilce.com y dejó la siguiente información:</p> <br>';
